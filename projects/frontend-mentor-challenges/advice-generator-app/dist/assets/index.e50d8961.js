  ...
  function E(C, P) {
    ...
    try {
      ...
      if (m !== null) var qt = !0;
        ...
        var vn = t(c);
        vn !== null && yl(h, vn.startTime - P), (qt = !1);
      }
      return qt;
    } finally {
      (m = null), (p = z), (g = !1);
...
function bl(e, n) {
  ...
  n.hasOwnProperty("value")
    ? eo(e, n.type, t)
    : n.hasOwnProperty("defaultValue") && eo(e, n.type, cn(n.defaultValue)),
    n.checked == null &&
...
function Ku(e) {
  if ((e = Zt(e))) {
    ...
    var n = e.stateNode;
    n && ((n = ll(n)), uo(e.stateNode, e.type, n));
  }
}
function ms(e) {
...
function vs() {
  if (Qn) {
    var e = Qn,
      n = Kn;
    if (((Kn = Qn = null), Ku(e), n)) for (e = 0; e < n.length; e++) Ku(n[e]);
  }
}
function hs(e, n) {
  return e(n);
...
function Tc(e, n, t, r, l, o, u, i, s) {
  (Et = !1), (Tr = null), zc.apply(Lc, arguments);
}
function Rc(e, n, t, r, l, o, u, i, s) {
  if ((Tc.apply(this, arguments), Et)) {
    if (Et) {
      var c = Tr;
      (Et = !1), (Tr = null);
...
var Ir = null;
function fo(e, n, t, r) {
  if (((Ir = null), (e = Zo(r)), (e = wn(e)), e !== null))
...
var wf = He && "TextEvent" in window && !Ct,
  Ds = He && (!lu || (Ct && 8 < Ct && 11 >= Ct)),
...
function $s(e) {
  if (e.propertyName === "value" && tl(Ft)) {
    var n = [];
    js(n, Ft, e, Zo(e)), gs(Cf, n);
  }
}
function xf(e, n, t) {
  e === "focusin"
    ? (oi(), (_t = n), (Ft = t), _t.attachEvent("onpropertychange", $s))
    : e === "focusout" && oi();
}
function Nf(e) {
      ...
      N &&
        (Ds &&
          ...
          (Dn || N !== "onCompositionStart"
            ? N === "onCompositionEnd" && Dn && (x = Ms())
            : ((be = v),
              (nu = "value" in be ? be.value : be.textContent),
              (Dn = !0))),
        (_ = Fr(c, N)),
        0 < _.length &&
...
function mn() {
  if (!Fl && $e !== null) {
    ...
    try {
      ...
      throw ($e !== null && ($e = $e.slice(e + 1)), Es(Jo, mn), l);
    } finally {
      (O = n), (Fl = !1);
    }
  }
...
function Wr(e, n, t, r) {
  ...
  if (o !== null) {
    ...
    (Pn |= u), (e.lanes = u), (e.memoizedState = m);
  }
}
function ki(e, n, t) {
...
function Ea(e, n, t) {
  return (Nn & 21) === 0
    ...
    : (Oe(t, n) || ((t = xs()), ($.lanes |= t), (Pn |= t), (e.baseState = !0)),
      n);
}
function Qf(e, n) {
  var t = O;
...
function Ri(e, n, t, r, l) {
  ...
  if ((Xn(n, l), n.stateNode === null))
    xr(e, n), la(n, t, r), xo(n, t, r, l), (r = !0);
  else if (e === null) {
    var u = n.stateNode,
      i = n.memoizedProps;
    u.props = i;
  ...
  if (t)
    return n.flags & 256
      ...
      : ((o = r.fallback),
        ...
        (n.memoizedState = Lo),
        o);
  if ((n.mode & 1) === 0) return pr(e, n, u, null);
  if (l.data === "$!") {
...
function Ua(e) {
  ...
  n !== null && ((e.alternate = null), Ua(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[At], delete n[wo], delete n[Af], delete n[Vf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Ha(e, n) {
  if (((Nr = -1), (Pr = 0), (R & 6) !== 0)) throw Error(y(327));
  var t = e.callbackNode;
  ...
  if (n !== 0) {
    ...
    if (n === 6) qe(e, r);
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            (qe(e, r), (r & 130023424) === r && ((n = xu + 500 - W()), 10 < n))
          ) {
            if (Mr(e, 0) !== 0) break;
            ...
            e.timeoutHandle = go(gn.bind(null, e, se, Ue), n);
            break;
          }
          gn(e, se, Ue);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = go(gn.bind(null, e, se, Ue), r);
            break;
          }
          gn(e, se, Ue);
          break;
...
function Jr(e, n) {
  ...
  while (1);
  if ((cu(), (R = t), (Xr.current = r), Q !== null)) throw Error(y(261));
  return (Z = null), (q = 0), Y;
}
function sd() {
  for (; Q !== null; ) Ka(Q);
...
function cd(e, n, t, r) {
  ...
  if (Gr) throw ((Gr = !1), (e = Fo), (Fo = null), e);
  return (
    (Zr & 1) !== 0 && e.tag !== 0 && Gn(),
    (o = e.pendingLanes),
...
dl.prototype.render = Ou.prototype.render = function (e) {
  var n = this._internalRoot;
  if (n === null) throw Error(y(409));
  fl(e, n, null, null);
};
dl.prototype.unmount = Ou.prototype.unmount = function () {
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (qo(n, t | 1), de(n, W()), (R & 6) === 0 && ((rt = W() + 500), mn()));
      }
      break;
    case 13:
      zn(function () {
...
hs = Nu;
ys = zn;
var kd = { usingClientEntryPoint: !1, Events: [Zt, jn, ll, ms, vs, Nu] },
  ht = {
...
const br = Du.exports.jsx,
  Ql = Du.exports.jsxs,
  zd = () => {
    const [e, n] = Zn.exports.useState({}),
      t = async () => {
        try {
          const l = await (
    ...
    return (
      Zn.exports.useEffect(() => {
        t();
      }, []),
      Ql("div", {
        className: "advice-generator",
        children: [
          Ql("p", { className: "advice-id", children: ["ADVICE #", e.id] }),
          Ql("p", { className: "advice", children: ['"', e.advice, '"'] }),
          br("div", { className: "advice-divider" }),
          br("button", { className: "advice-btn", onClick: t }),
        ],
      })
    );
  };
Kl.createRoot(document.getElementById("iframe-root")).render(
  br(gc.StrictMode, { children: br(zd, {}) })
);
